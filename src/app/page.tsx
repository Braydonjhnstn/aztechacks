...
export default function Home() {
  ...
  // Track scroll of the Parallax internal container (desktop only)
  useScroll({
    // Parallax exposes the scrollable element as `container`
    container: !isMobile ? (parallaxRef.current?.container as React.MutableRefObject<HTMLElement> | undefined) : undefined,
  ...
  useEffect(() => {
    ...
    // Only enable sticky scroll behavior on desktop
    if (isMobile) return;
  ...
  // Mobile version - simple scrollable layout
  if (isMobile && mounted) {
    ...
    return (
      <div className="w-full bg-white">
        ...
        <section className="relative w-full min-h-screen bg-white overflow-hidden flex items-center">
          ...
          {/* Navigation */}
          <nav className="fixed top-4 right-4 z-20 flex flex-col gap-1 text-gray-500 text-sm">
            <button 
          ...
          {/* Main Content */}
          <div className="z-10 pl-4 md:pl-16 w-full">
            <div className="flex flex-col items-start">
              {words.map((word, index) => (
                ...
                >
                  <h1 className="text-[15vw] font-black leading-[0.85] tracking-tighter text-gray-900">
                    {word}
                  </h1>
                  <motion.span
                    ...
                    className="text-[7vw] font-black leading-[0.85] tracking-tighter text-red-600 ml-2"
                  >
                    2026
                  </motion.span>
                </motion.div>
            ...
            <motion.div
              ...
              className="mt-8"
            >
              <div className="text-xl text-gray-600 font-medium">by</div>
              <div className="flex flex-col">
                {["WORLD", "COMPUTING", "ORGANIZATION"].map((word, index) => (
                  <motion.div
                    ...
                    className="text-[5vw] font-black leading-[0.85] tracking-tighter text-gray-900"
                  >
        ...
        {/* Partners Section */}
        <section ref={partnersRef} className="w-full min-h-screen flex flex-col items-center justify-center px-4 py-16 bg-white">
          <h2 className="text-4xl font-black mb-8 text-gray-900">PARTNERS</h2>
          <div className="flex flex-col items-center justify-center space-y-12 mb-8">
            <img src="/SDSU.svg.png" alt="SDSU Logo" className="w-48 h-48 object-contain" />
            <img src="/WCO1.png" alt="WCO Logo" className="w-48 h-48 object-contain" />
          </div>
          <p className="text-sm text-gray-700 text-center mb-2">WANT YOUR LOGO HERE?</p>
          <p className="text-sm text-gray-700 text-center">EMAIL INFO@AZTECHACKS.COM FOR SPONSORSHIP INQUIRIES</p>
        </section>

        {/* About Section */}
        <section ref={aboutRef} className="w-full min-h-screen flex flex-col items-center justify-center px-4 py-16 bg-white">
          <img src="/AZTECHACKS.png" alt="AZTECHACKS Logo" className="w-64 h-auto mb-8" />
          <h2 className="text-4xl font-black text-gray-900 mb-8">ABOUT</h2>
          <div className="text-center max-w-4xl px-4">
            <p className="text-base text-gray-900 mb-6 leading-relaxed uppercase font-medium">
        ...
        {/* Schedule Section */}
        <section ref={scheduleRef} className="w-full min-h-screen flex flex-col items-start justify-start px-4 py-16 bg-white">
          <div className="text-center w-full mb-8">
            <h2 className="text-4xl font-black text-gray-900">2026 SCHEDULE</h2>
          </div>
          <div className="w-full overflow-x-auto">
            <table className="w-full border-collapse text-left text-sm">
              <thead>
                <tr className="border-b-2 border-gray-900">
                  <th className="py-2 px-3 font-black text-gray-900">TIME</th>
                  <th className="py-2 px-3 font-black text-gray-900">DAY</th>
                  <th className="py-2 px-3 font-black text-gray-900">EVENT</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-200">
                  <td className="py-2 px-3 text-gray-700">9:00AM - 11:00AM</td>
                  <td className="py-2 px-3 text-gray-700">APRIL 4</td>
                  <td className="py-2 px-3 text-gray-700">CHECK-IN, TEAM MATCHING BEGINS</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-2 px-3 text-gray-700">10:30AM - 11:00AM</td>
                  <td className="py-2 px-3 text-gray-700"></td>
                  <td className="py-2 px-3 text-gray-700">WORD FROM SPONSORS</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-2 px-3 text-gray-700">11:00AM - 12:00PM</td>
                  <td className="py-2 px-3 text-gray-700"></td>
                  <td className="py-2 px-3 text-gray-700">OPENING CEREMONY, KICKOFF</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-2 px-3 text-gray-700">12:00PM - 1:00PM</td>
                  <td className="py-2 px-3 text-gray-700"></td>
                  <td className="py-2 px-3 text-gray-700">HACKING BEGINS</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-2 px-3 text-gray-700">12:30PM - 1:15PM</td>
                  <td className="py-2 px-3 text-gray-700"></td>
                  <td className="py-2 px-3 text-gray-700">WELCOMING WORKSHOP</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-2 px-3 text-gray-700">1:30PM - 2:00PM</td>
                  <td className="py-2 px-3 text-gray-700"></td>
                  <td className="py-2 px-3 text-gray-700">LUNCH BREAK</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-2 px-3 text-gray-700">2:00PM - 2:30PM</td>
                  <td className="py-2 px-3 text-gray-700"></td>
                  <td className="py-2 px-3 text-gray-700">HACKING CONTINUES</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-2 px-3 text-gray-700">3:00PM - 3:45PM</td>
                  <td className="py-2 px-3 text-gray-700"></td>
                  <td className="py-2 px-3 text-gray-700">DEVELOPMENT AND CODE SHARING</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-2 px-3 text-gray-700">6:00PM - 6:30PM</td>
                  <td className="py-2 px-3 text-gray-700"></td>
                  <td className="py-2 px-3 text-gray-700">DINNER</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-2 px-3 text-gray-700">7:00PM - 7:00AM</td>
                  <td className="py-2 px-3 text-gray-700"></td>
                  <td className="py-2 px-3 text-gray-700">OVERNIGHT HACKING</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-2 px-3 text-gray-700">7:30AM - 8:30AM</td>
                  <td className="py-2 px-3 text-gray-700">APRIL 5</td>
                  <td className="py-2 px-3 text-gray-700">PROJECT PRESENTATIONS</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-2 px-3 text-gray-700">8:30AM - 9:00AM</td>
                  <td className="py-2 px-3 text-gray-700"></td>
                  <td className="py-2 px-3 text-gray-700">JUDGING AND AWARDS CEREMONY</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        {/* Contact Section */}
        <section className="w-full min-h-screen flex flex-col items-center justify-center px-4 py-16 bg-white">
          <div className="flex flex-col items-center justify-center gap-8 mb-8">
            <Link href="https://sdsu.worldcomputing.org/" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:text-gray-600 transition-colors text-base uppercase">
              ABOUT US
            </Link>
            <img 
              src="/WCO_LOGO.png" 
            ...
            />
            <a href="mailto:info@aztechacks.com" className="text-gray-900 hover:text-gray-600 transition-colors text-base uppercase">
              CONTACT US
            </a>
          </div>

          <div className="text-center text-gray-900 mb-8">
            <p className="text-sm">MADE BY THE WORLD COMPUTING ORGANIZATION AT SAN DIEGO STATE UNIVERSITY</p>
          </div>
  ...
  // Desktop version - Parallax layout
  return (
    <div 
